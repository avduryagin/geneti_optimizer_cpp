...
int main()
{
    ...
    */
    ...
    std::string jpath = "C:\\Users\\avduryagin\\PycharmProjects\\GeneticOptimizer\\data\\data.json";
    ...
    Individ individ = *population.optimal_individ;
